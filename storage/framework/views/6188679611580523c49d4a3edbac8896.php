                                        ...
                                        <td>
                                            <span class="fw-semibold">
                                                <?php if(!empty($model->image)): ?>
                                                    <img src="<?php echo e(asset('public/admin/assets/img/pages')); ?>/<?php echo e($model->image); ?>" style="width:100px; height:40px" alt="">
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('public/admin/default.png')); ?>" style="width:100px" alt="">
                                                <?php endif; ?>
                                            </span>
                                        </td>
                                        <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hr_portal\resources\views/admin/profile_cover_images/index.blade.php ENDPATH**/ ?>