...
<input type="hidden" id="page_url" value="<?php echo e(route('work_shifts.index')); ?>">
            ...
            <div class="col-md-8">
                <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <a data-toggle="tooltip" data-placement="top" title="All Trashed Records" href="<?php echo e(route('work_shifts.trashed')); ?>" class="btn btn-danger mx-3">
                            <span>
                    ...
                    <div class="dt-buttons btn-group flex-wrap">
                        <button
                            ...
                            title="Add New"
                            id="add-btn"
                            data-url="<?php echo e(route('work_shifts.store')); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hr_portal\resources\views/admin/work_shifts/index.blade.php ENDPATH**/ ?>