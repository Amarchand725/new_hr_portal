...
@section('title', 'Dashboard - Cyberonix')
@push('styles')
      ...
      <div class="col-md-9">
         <div class="card mb-4">
            <div class="user-profile-header-banner">
               <img src="{{ asset('public/admin/assets/img/backgrounds/profilebg.jpg') }}" alt="Banner image" class="rounded-top img-fluid">
            </div>
            <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
               <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                  <img src="{{ asset('public/admin/assets/img/avatars/14.png') }}" alt="user image" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img">
               </div>
            ...
            <div class="reporting-authority position-relative text-center">
               ...
               <div class="card-body">
                  <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto user-profile-header">
                     <img src="{{ asset('public/admin/assets/img/avatars/1.png') }}" alt="user image" class="d-block mx-auto rounded user-profile-img border-5">
                  </div>
                  <h3 class="mt-1">
                  Amir Ali
                  <h3>
            ...
            <div class="d-flex align-items-end row">
               <div class="col-7">
                  <div class="card-body text-nowrap">
                     <h5 class="card-title mb-3">Congratulations John! 🎉</h5>
                        ...
                        <tr>
                           <td>
                              <div class="d-flex justify-content-start align-items-center user-name">
                                 <div class="avatar-wrapper">
                                    <div class="avatar me-2">
                                       <img src="{{ asset('public/admin/assets/img/avatars/1.png') }}" alt="Avatar" class="rounded-circle">
                                    </div>
                                 </div>
                                 <div class="d-flex flex-column">
                                    <span class="emp_name text-truncate">Muhammad Yousuf Khan</span>
                        ...
                        <tr>
                           <td>
                              <div class="d-flex justify-content-start align-items-center user-name">
                                 <div class="avatar-wrapper">
                                    <div class="avatar me-2">
                                       <img src="{{ asset('public/admin/assets/img/avatars/5.png') }}" alt="Avatar" class="rounded-circle">
                                    </div>
                                 </div>
                                 <div class="d-flex flex-column">
                                    <span class="emp_name text-truncate">Muhammad Yousuf Khan</span>
                        ...
                        <tr>
                           <td>
                              <div class="d-flex justify-content-start align-items-center user-name">
                                 <div class="avatar-wrapper">
                                    <div class="avatar me-2">
                                       <img src="{{ asset('public/admin/assets/img/avatars/6.png') }}" alt="Avatar" class="rounded-circle">
                                    </div>
                                 </div>
                                 <div class="d-flex flex-column">
                                    <span class="emp_name text-truncate">Muhammad Yousuf Khan</span>
