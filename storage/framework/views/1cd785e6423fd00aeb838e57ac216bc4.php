                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end m-0">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-show-url="<?php echo e(route('departments.show', $model->id)); ?>"
                                                        >
                                                        View Details
                                                    </a>
                                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="position-relative">
                                    <select id="manager_id" name="manager_id" class="select2 form-select">
                                        ...
                                        <?php $__currentLoopData = $data['department_managers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
