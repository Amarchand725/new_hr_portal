    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="col-xl-10 offset-1">
                <div class="card-body">
                    <form action="{{ route('settings.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PATCH') }}
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                @if(!empty($model->logo))
                                    <div id="logo-preview">
                                        <img style="width:10%; height:5%" src="{{ asset('public/admin/assets/img/logo') }}/{{ $model->logo }}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="col-md-10">
                                @if(!empty($model->favicon))
                                    <div id="favicon-preview">
                                        <img style="width:10%; height:5%" src="{{ asset('public/admin/assets/img/favicon') }}/{{ $model->favicon }}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="col-md-10">
                                @if(!empty($model->banner))
                                    <div id="banner-preview">
                                        <img style="width:10%; height:5%" src="{{ asset('public/admin/assets/img/banner') }}/{{ $model->banner }}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
