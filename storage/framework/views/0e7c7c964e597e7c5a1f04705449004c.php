        ...
        <div class="card">
            <div class="card-header border-bottom">
                ...
                <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 gap-md-0">
                    <input type="hidden" id="filter-url" value="<?php echo e(route('employees.filter-payslip')); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hr_portal\resources\views/admin/employees/pay_slip.blade.php ENDPATH**/ ?>