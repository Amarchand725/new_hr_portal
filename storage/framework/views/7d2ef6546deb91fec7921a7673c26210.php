...
<input type="hidden" id="page_url" value="<?php echo e(route('announcements.index')); ?>">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:;"
                                                        ...
                                                        data-placement="top"
                                                        title="Show Details"
                                                        data-show-url="<?php echo e(route('announcements.show', $model->id)); ?>"
                                                        class="text-body show"
                                                        type="button"
                                                        tabindex="0" aria-controls="DataTables_Table_0"
                                                        type="button" data-bs-toggle="modal"
                                                        data-bs-target="#offcanvasShowAnnouncement"
    ...
    <!--Sho Announcement Details Modal -->
    <div class="modal fade" id="offcanvasShowAnnouncement" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered1 modal-simple modal-add-new-cc">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
