    ...
    <ul class="menu-inner py-1">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employee-list')): ?>
            <li class="menu-item <?php echo e(request()->is('employees') ||
                ...
                <ul class="menu-sub">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('designation-list')): ?>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employmentstatus-list')): ?>
        ...
        <?php if(!isOnProbation()): ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('leave-list')): ?>
                <li class="menu-item <?php echo e(request()->is('user_leaves') ||
                    ...
                    <ul class="menu-sub">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('leavestatus-list')): ?>
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('leavereport-list')): ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('attendance-list')): ?>
            <li class="menu-item <?php echo e(request()->is('user/discrepancies') ||
                ...
                <ul class="menu-sub">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dailylog-list')): ?>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('discrepancy-list')): ?>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('summary-list')): ?>
                        <li class="menu-item">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('attendancefilter-list')): ?>
                        <li class="menu-item">
                            <a href="<?php echo e(route('permissions.index')); ?>" class="menu-link">
        ...
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('adminstration-list')): ?>
            <li class="menu-item  <?php echo e(request()->is('roles') ||
                ...
                <ul class="menu-sub">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('position-list')): ?>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('workshift-list')): ?>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('profilecoverimage-list')): ?>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('leavetype-list')): ?>
