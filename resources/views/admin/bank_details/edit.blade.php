                    ...
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <!-- Add role form -->
                                    <form class="pt-0 fv-plugins-bootstrap5 fv-plugins-framework mt-3" data-method="PUT" action="{{ route('bank_details.update', $model->id) }}" id="create-form" data-modal-id="bank-details">
                                        @csrf
