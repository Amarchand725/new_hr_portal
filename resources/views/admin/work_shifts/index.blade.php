                                ...
                                <div class="dt-buttons btn-group flex-wrap">
                                    <button class="btn btn-secondary add-new btn-primary mx-3" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser" fdprocessedid="i1qq7b">
                                        <span>
                                            ...
                                            <span class="d-none d-sm-inline-block">Add New Work Shift</span>
                                        </span>
                                    </button>
                                </div>
                            </div>
                    ...
                    <table class="datatables-users table border-top dataTable no-footer dtr-column" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="width: 1227px;">
                        ...
                        <tbody>
                            <tr class="odd">
                                ...
                                <td>End date</td>
                                <td>
                                    <span class="badge bg-label-success" text-capitalized="">Type</span>
                                </td>
                                <td>Start Time</td>
                                <td>End Time</td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end m-0">
                                            <a href="app-user-view-account.html" class="dropdown-item">Add Employee</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
