                    ...
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <!-- Add role form -->
                                    <form class="pt-0 fv-plugins-bootstrap5 fv-plugins-framework mt-3" data-method="PUT" action="<?php echo e(route('bank_details.update', $model->id)); ?>" id="create-form" data-modal-id="bank-details">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hr_portal\resources\views/admin/bank_details/edit.blade.php ENDPATH**/ ?>